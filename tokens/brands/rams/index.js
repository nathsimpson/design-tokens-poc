const palette = {
  ...
  focus: { value: "#009CDB", private: true },
  heading: { value: "#1972B4", private: true },
  hero: { value: "#0F446C", private: true },
  light: { value: "#FAFAFA", private: true },
  link: { value: "#1972B4", private: true },
  muted: { value: "#6A6E72", private: true },
  neutral: { value: "#848588", private: true },
  pop: { value: "#78C339", private: true },
  primary: { value: "#047DBC", private: true },
